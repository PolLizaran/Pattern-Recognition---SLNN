...
tr_seed = 49362111;
te_seed = 49290219;
tr_p = 20000; te_q = tr_p/10; tr_freq = 0.0;  te_freq = 0.0;  % Datasets generation
...
sg_seed = 21021119; sg_al0 = 2; sg_be = 0.3; sg_ga = 0.01;    % SGM iteration.
...
global iheader;
iheader = 1;
csvfile = strcat('uo_nn_batch_',num2str(tr_seed),'-',num2str(te_seed), 'Part2','.csv');
